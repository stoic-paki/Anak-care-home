...
const MainServiceDesktop = () => {
  const settings = {
    ...
    responsive: [
    {
      breakpoint: 769,      // screens ≥ 769px (typical tablet and up)
      settings: {
        slidesToShow: 2,
        slidesToScroll: 1   // or 2 if you want to swipe two at a time
      }
    },
    // Optional: if you want 3+ on big desktops, add another breakpoint
    // {
    //   breakpoint: 1024,
    //   settings: {
    //     slidesToShow: 3,
  ...
  return (
    <section className="main-service flex flex-col justify-center items-center bg-neutral-100 h-full w-full gap-10">
      <h1 className="text-3xl md:text-4xl font-bold text-center mb-6 px-4">
...
export default MainServiceDesktop;
